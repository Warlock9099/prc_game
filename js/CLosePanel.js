function CLosePanel(iPlayerRank){
    ...
    this._init = function(){
        ...
        timeLap = new CTLText(_oPanelContainer,
                    -300,-100, 600, 200, 
                    50, "center", "#fff", PRIMARY_FONT, 1.1,
                    0, 0,
                    sprintf("TOTAL TIME :   00:00:00"),
                    true, true, true,
                    false );
        timeLap.setStroke(10,"#000")
                    
        
        var oSprite = s_oSpriteLibrary.getSprite('but_exit');
        _oExitBut = new CGfxButton(0, 120, oSprite,_oPanelContainer);
    ...
    this.refreshLapText = function(totalTime){
        timeLap.refreshText(`TOTAL TIME :  ${totalTime}`)
    }
