function CMain(oData){
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("auto_acceleration","./sprites/auto_acceleration.png");
        s_oSpriteLibrary.addSprite("auto_acceleration_mb","./sprites/auto_accelerationss.png");
        ...
        s_oSpriteLibrary.addSprite("start_position","./sprites/start_position_right.png")
        s_oSpriteLibrary.addSprite("lstart_position","./sprites/start_position_left.png")
        ...
        for(i=1;i<19;i++){
            s_oSpriteLibrary.addSprite("coin"+i,"./sprites/coins/coin"+i+".png");
        }
        for(i=0;i<11;i++){
            s_oSpriteLibrary.addSprite("coinHit"+i,"./sprites/coin_hit/coin_hit_"+i+".png");
        }
        // tank anim
        s_oSpriteLibrary.addSprite("b1","./sprites/boost_tank/b_tank_02.png");        
        s_oSpriteLibrary.addSprite("b2","./sprites/boost_tank/b_tank_12.png");
        s_oSpriteLibrary.addSprite("b3","./sprites/boost_tank/b_tank_22.png");
        // s_oSpriteLibrary.addSprite("b4","./sprites/boost_tank/b_tank_.png");

        s_oSpriteLibrary.addSprite("t1","./sprites/boost_tank/b_tank_03.png");        
        s_oSpriteLibrary.addSprite("t2","./sprites/boost_tank/b_tank_13.png");
        s_oSpriteLibrary.addSprite("t3","./sprites/boost_tank/b_tank_23.png");
        s_oSpriteLibrary.addSprite("t4","./sprites/boost_tank/b_tank_33.png");
        
        s_oSpriteLibrary.addSprite("boost1","./sprites/boost_tank/boost_tank_1.png");
        s_oSpriteLibrary.addSprite("boost2","./sprites/boost_tank/boost_tank_2.png");
        s_oSpriteLibrary.addSprite("boost3","./sprites/boost_tank/boost_tank_3.png");
        s_oSpriteLibrary.addSprite("boost4","./sprites/boost_tank/boost_tank_4.png"); 
        ...
        for(var i=0; i<13; i++){
            s_oSpriteLibrary.addSprite("backfire"+i,"./sprites/fire_particle/backfire"+i+".png");
        }
        ...
        s_oSpriteLibrary.addSprite("coin","./sprites/elements/day/coin.png");
        s_oSpriteLibrary.addSprite("star_coin","./sprites/elements/day/star_coin.png");
        s_oSpriteLibrary.addSprite("security_wall","./sprites/elements/day/security_wallw.png");
        s_oSpriteLibrary.addSprite("security_wally","./sprites/elements/day/security_wally.png");
        s_oSpriteLibrary.addSprite("security_wallx","./sprites/elements/day/security_wallx.png");
        s_oSpriteLibrary.addSprite("security_wallz","./sprites/elements/day/security_wallz.png");
