function CNextLevelPanel(iRank, iScore, iLevel){
    ...
    this._init = function(iRank, iScore, iLevel){
        ...
        oTitle = new CTLText(_oPanelContainer, 
                    -300, -200, 600, 100, 
        ...
        oCup.regY = oSprite.height/2-100;
        oCup.scale = 0.5;
        ...
        oStar.regY = oSprite.height/2-50;
        ...
        _oContinueBut = new CGfxButton(120, 140, oSprite,_oPanelContainer);
        _oContinueBut.addEventListener(ON_MOUSE_UP, this._onContinue, this);
        _oContinueBut.pulseAnimation();
        
        var oSprite = s_oSpriteLibrary.getSprite('but_restart');
        _oRestartBut = new CGfxButton(-120, 140, oSprite,_oPanelContainer);
    ...
    this.refreshLapText = function(totalTime){
        oTitle.refreshText(TEXT_TRACK_COMPLETED+"\n"+`TOTAL LAP TIME :   ${totalTime}`)
    }
