function COpponent(iType, iOffset, iZ, iSpeed, oElementContainer, iIndex){
    ...
    this.setDifficultyParams = function(iSkillLevel,speed){
        _iSkillLevel = iSkillLevel;
        
        var iMaxSpeedRef = percentScale(PLAYER_MAX_SPEED, 90);
        var iMinSpeedRef = percentScale(PLAYER_MAX_SPEED, 80);
        // console.log("iMaxSpeedRef",iMaxSpeedRef,"iMinSpeedRef",iMinSpeedRef)
        var iBestSkill = 10;
