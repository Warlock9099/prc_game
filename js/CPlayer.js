function CPlayer(iX, iY, oParentContainer){
    ...
    this._init = function(iX, iY, oParentContainer){
        ...
        _oPlayer = createSprite(s_aSpriteSheetCharacters[(getParamValue('car') - 1 || 0)], "center",0,0,0,0);
    ...
    this.setBoostSpeed = function(iVal){
        _iBoostSpeed = iVal;
        setTimeout(() => {
            _iBoostSpeed = _iBoostSpeed - 1;
        }, 1000);
    };

    this.getBoostSpeed = function(iVal){
        return _iBoostSpeed
    };
