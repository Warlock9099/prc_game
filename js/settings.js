...
var TRACK = 0
var COIN_COUNT = '0'
var COIN_BOOL = (getParamValue('coin')=="false"?false:true)
var CAR_BOOST = (getParamValue('carBoost')=='false'?false:true)
var BOOST_COUNT = '0'
var START_TIME;
var FINSIH_TIME
var PLAYER_LAP_COMPTD = [false]
var TRACK_COMPTD = false
var NumberOfLaps ;
var LAPS = []
var BOOST_TRIGGER = 100
...
var SPRITES = {
    //DAY
  START_POSITION:           {name:"start_position",     physics:{base:30}  },
  LSTART_POSITION:          {name:"lstart_position",    physics:{base:30}} ,
  ...
  COIN:                   {name: "coin",               physics:{base:30, width:100},type:ELEMENT_TYPE_ANIMATED },
  SIDE_GRASS:                   {name: "side_grass",               physics:{base:30,width:200} },
  SIDE_GRASSL:                   {name: "side_grassL",               physics:{base:30,width:200} },
  FENCE_SIDE:                   {name: "fence-side",               physics:{base:10,center:500,width:100} },
  SECURITY_WALL:                   {name: "security_wall",               physics:{width:700} },
  SECURITY_WALLY:                   {name: "security_wally",               physics:{width:700} },
  SECURITY_WALLX:                   {name: "security_wallx",               physics:{width:700} },
  SECURITY_WALLZ:                   {name: "security_wallz",               physics:{width:700} },
};
